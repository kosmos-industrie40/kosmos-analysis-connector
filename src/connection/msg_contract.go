...
// ContractInfos contains contract info specificas
...
// Container describes a contianer in the contract message
...
// PipelinesMlTrigger contins the datype of the ml trigger
